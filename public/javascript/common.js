...
function createPostHtml(postdata,italicFont=false){
    ...
    var retweetButtonActive = postdata.retweetUsers.includes(userLoggedIn._id) ? "active" : "";
    var italicFontClass = italicFont ? "italicFont" : "";
    ...
    return `<div class='post ${italicFontClass}' data-id="${postdata._id}">
                        ...
                        <div class='postFooter'>
                            ...
                            <div class='postButtonContainer green'>
                                <button class="retweetButton  ${retweetButtonActive}">
                                    <i class='fas fa-retweet'></i>
                                    <span class="retweetNumber">${postdata.retweetUsers.length || ""}</span>
                                </button>
                            </div>
                            <div class='postButtonContainer red'>
                                <button class="likeButton ${likeButtonActive}">
                                    <i class='far fa-heart'></i>
                                    <span class="likesNumber">${postdata.likes.length || ""}</span>
                                </button>
                            </div>
                        </div>
                    </div>
